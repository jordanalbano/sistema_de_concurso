...
import proyecto.sistema.de.restaurant.modelo.TarjetaViedma;

class TarjetaViedmaTest {

	@Test
	void calcularCostoConTarjetaViedmaTest() {
		// setup
		TarjetaViedma tarjetaComarcaPlus = new TarjetaViedma(2.0);
		...
		// verificar
		assertEquals(1020, res, 0.01);// tercer valor
	}
