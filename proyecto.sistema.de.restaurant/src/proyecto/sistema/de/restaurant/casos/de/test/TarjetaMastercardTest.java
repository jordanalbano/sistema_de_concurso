...
import proyecto.sistema.de.restaurant.modelo.TarjetaMastercard;

class TarjetaMastercardTest {

	@Test
	void calcularCostoConTarjetaMastercard() {
		// setup
		TarjetaMastercard tarjetaComarcaPlus = new TarjetaMastercard(2.0);
